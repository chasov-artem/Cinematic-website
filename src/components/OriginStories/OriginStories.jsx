...
function OriginStories() {
  ...
  const stories = [
    ...
    },
    {
      ...
      image: "/jasmine.webp",
      videoSrc:
        "https://wakanda-forever-master.dogstudio-dev.co/zerolimits/assets/videos/jasmine.webm",
      audioSrc: "/audio2.mp3",
    },
    {
      id: 3,
      ...
      image: "/alicia.webp",
      videoSrc:
        "https://wakanda-forever-master.dogstudio-dev.co/zerolimits/assets/videos/alicia.webm",
      audioSrc: "/audio3.mp3",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div
        ref={topLogoRef}
        className={`${welcomeStyles.topLogo} ${styles.topLogo}`}
      >
        <img
          src="/hall-logo.svg"
      ...
      <div ref={watchButtonsRef} className={styles.watchButtonsContainer}>
        {[1, 2, 3].map((index) => {
          // Кнопка активна, якщо модальне вікно відкрите для цієї історії АБО історія вже переглянута
          const isCurrentlyOpen =
            isModalOpen && selectedStory && selectedStory.id === index;
      ...
      <div
        ...
        className={`${welcomeStyles.welcomeCenter} ${styles.welcomeCenterOrigin}`}
      >
