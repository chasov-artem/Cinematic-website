...
function InspirationGarden() {
  ...
  const quotes = [
    ...
    },
    {
      ...
      description:
        "Both a problem solver and maker by nature, Shuri is a visionary, illuminator, decoder, explorer and avant-garde. She's unapologetically bold in her role as a leader across the board— as a master engineer, designer, tech inventor, mathematician, and scientist. Her innovations are of incredible importance to her community. Perhaps when you look at Shuri, you see glimpses of yourself there as well.",
    },
    {
      id: 3,
      character: "M'BAKU",
    ...
    >
      ...
      >
        {[1, 2, 3].map((index) => {
          ...
          const isWatched = watchedQuotes.has(index);
